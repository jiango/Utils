...
std::string Convert::w2utf8(const std::wstring& str)
{
	if (str.empty())
		return std::string("");
...
std::wstring Convert::utf82w(const std::string& str)
{
	if (str.empty())
...
std::string Convert::w2a(const std::wstring& str)
{
...
std::wstring Convert::a2w(const std::string& str)
{
...
std::string Convert::b64_encode(const char* src, int src_len)
{
...
std::string Convert::b64_decode(const char* src, int src_len)
{
